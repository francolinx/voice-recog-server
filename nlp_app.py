...
{'task_name': full task, 'priority': [Important or Not Important, Urgent or Not Urgent]}

In the response i just want an array of json objects with the categorization of the tasks as i mentioned and nothing else and make sure not to summarize the task.
...
# 6.Finishing a project with a last-minute due date
# 7.Professional networking to build a client base.
# 8.Regular chores and maintenance projects.
# """
